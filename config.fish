...
set -gu 'HM' "$HOME"'/src/haskell/my'
set -gu 'HH' "$HOME"'/src/haskell/my/hnix'
set -gu 'HS' "$HOME"'/src/haskell/my/hnix-store'
set -gu 'HZ' "$HOME"'/src/haskell/my/zen'
set -gu 'ZEN' "$HOME"'/src/haskell/my/zen'
set -gu 'HB' "$HOME"'/src/haskell/my/learning/Haskell-Programming-From-First-Principles'
set -gu 'HC' "$HOME"'/src/haskell/community'
set -gu 'HLS' "$HOME"'/src/haskell/community/haskell-language-server'
